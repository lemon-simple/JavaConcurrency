...
public class ConcurrentHashMap8<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
     ...
     *             recursive update to this map that would otherwise never
     *             complete
    ...
    public static <K> KeySetView<K, Boolean> newKeySet() {
        return new KeySetView<K, Boolean>(new ConcurrentHashMap8<K, Boolean>(), Boolean.TRUE);
    }
    ...
    public static <K> KeySetView<K, Boolean> newKeySet(int initialCapacity) {
        return new KeySetView<K, Boolean>(new ConcurrentHashMap8<K, Boolean>(initialCapacity), Boolean.TRUE);
    }
    ...
    static class BaseIterator<K, V> extends Traverser<K, V> {
        ...
        BaseIterator(Node<K, V>[] tab, int size, int index, int limit, ConcurrentHashMap8<K, V> map) {
    ...
    static final class KeyIterator<K, V> extends BaseIterator<K, V> implements Iterator<K>, Enumeration<K> {
        KeyIterator(Node<K, V>[] tab, int index, int size, int limit, ConcurrentHashMap8<K, V> map) {
    ...
    static final class ValueIterator<K, V> extends BaseIterator<K, V> implements Iterator<V>, Enumeration<V> {
        ValueIterator(Node<K, V>[] tab, int index, int size, int limit, ConcurrentHashMap8<K, V> map) {
            super(tab, index, size, limit, map);
        }
    ...
    static final class EntryIterator<K, V> extends BaseIterator<K, V> implements Iterator<Map.Entry<K, V>> {
        EntryIterator(Node<K, V>[] tab, int index, int size, int limit, ConcurrentHashMap8<K, V> map) {
            super(tab, index, size, limit, map);
        }
     ...
     *            element, or null if there is no transformation (in which case
    ...
    public static class KeySetView<K, V> extends CollectionView<K, V, K> implements Set<K>, java.io.Serializable {
         ...
         * @return {@code true} if this set changed as a result of the call
         * @throws NullPointerException if the collection or any of its elements
         *             are {@code null}
         * @throws UnsupportedOperationException if no default mapped value for
         *             additions was provided
         */
